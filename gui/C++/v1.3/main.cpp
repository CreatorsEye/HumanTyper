...
std::string engineLog = "[12:00:00] CE Commander Engine V1.3 \n> Clipboard feature restored.\n> GUI Layout adjusted.\n";
std::mutex logMutex;
...
int main() {
#ifdef _WIN32
    // SINGLE INSTANCE LOCK (v1.3)
    HANDLE hMutex = CreateMutexA(NULL, FALSE, "CE_AutoTyper_SingleInstance_Mutex_v1_3");
    ...
    GLFWwindow* window = glfwCreateWindow(800, 640, "CE Commander Engine v1.3", NULL, NULL);
    if (!window) return 1;
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        ImGui::TextColored(ImVec4(0.6f, 0.7f, 0.9f, 1.0f), "CE Commander Engine v1.3");
        ...
        // Formatted and Right-Aligned Hotkey Label
        char hkBuf[256];
        ...
        ImGui::SetCursorPos(ImVec2(800 - textWidth - 20, 195)); // Shifted to right side perfectly aligned with the textbox
