...
| Main Window | Hotkey Settings | Typing in Action |
|-------------|-----------------|------------------|
...
*All hotkeys can be changed via the **Set Hotkeys** button.*
...
- GitHub Issues: [Create an issue](https://github.com/yourusername/CreatorsEye-AutoTyper/issues)
