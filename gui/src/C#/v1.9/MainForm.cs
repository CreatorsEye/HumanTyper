...
namespace CeAutoTyper
{
    public class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            this.Text = "CE Auto Typer v1.9";
            this.Size = new Size(660, 560);
            this.StartPosition = FormStartPosition.CenterScreen;
            this.BackColor = Color.FromArgb(30, 30, 35);
            this.FormBorderStyle = FormBorderStyle.FixedSingle;
            this.MaximizeBox = false;
            this.TopMost = false;  // Start normal
            this.ShowIcon = true;
            ...
            try
            {
                using (Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("CeAutoTyper.ce.ico"))
                {
                    if (stream != null)
                    {
                        ...
                        trayIcon.Text = "CE Auto Typer v1.9";
        ...
        private async void BtnStart_Click(object? sender, EventArgs e)
        {
            ...
            // Make window stay on top during typing
            this.TopMost = true;
        ...
        private void ResetUI()
        {
            ...
            // Remove stay on top when typing ends
            this.TopMost = false;
    ...
    // =========================================================
    // TYPING ENGINE v1.9 - HUMAN-LIKE FIX TYPO
    // =========================================================
