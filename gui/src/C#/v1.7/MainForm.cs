...
namespace CeAutoTyper
{
    public class MainForm : Form
    {
        ...
        private ComboBox cmbFixTypo;               // NEW: Fix Typo Yes/No
        ...
        public MainForm()
        {
            ...
            this.Text = "CE Auto Typer v1.7";
            this.Size = new Size(660, 560);  // a bit wider
            ...
            try
            {
                using (Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("CeAutoTyper.ce.ico"))
                {
                    if (stream != null)
                    {
                        ...
                        trayIcon.Text = "CE Auto Typer v1.7";
            ...
            cmbFixTypo.SelectedIndex = 0; // Yes by default
            UpdateFixTypoState();
    ...
    // TypingEngine with Fix Typo support
    public class TypingEngine
    {
        ...
        private bool fixTypo = true;   // default Yes
            ...
            for (int i = 0; i < text.Length; i++)
            {
                ...
                if (makeMistake && i < text.Length - 1)
                {
                    ...
                    if (word.Length > 2)
                    {
                        ...
                        {
                            // Backspace all characters of the typo
